...
<body class="site-navbar-small ">
    ...
    <div class="page-content container-fluid">
      <div class="panel">
        <div class="panel-head">
          <h2 class="panel-title text-center">Edit</h2>
        </div>
  ...
  <script>
    function search(event) {
      ...
      url = "<?php echo base_url(); ?>Admin/users_getEditSearchResults";
      $.post(
        url,
        postdata, 
        function(data) {
    ...
    function delete_user(user_id) {
      var url = "<?php echo base_url(); ?>Admin/delete_user/" + user_id;
      $.get(
        url,
        function(data) {
            if (data == '1') {
              // Show the user as deleted!
              selecttion = 'tr#'+user_id+' .action';
              $(selecttion).html('Deleted Successfully!');
            }else{
              // There was an error in deleting the user!
            }
      });
    }
