    ...
    <div class="page-content container-fluid">
      <div class="panel">
        ...
        <div class="panel-body container">
          ...
          <?php 
            if ($news_article) {
              $main_content_id = $news_article->main_content_id;
              $content_category_id = $news_article->content_category_id;
              $content_posted_by_user_id = $news_article->content_posted_by_user_id;
              $main_content_name = $news_article->main_content_name;
              $content_text = $news_article->content_text;
              $content_date = $news_article->content_date;
            }else{
...
<script>
    ...
    function submitNews(){
      ...
      $.post("<?php echo base_url() ?>Admin/edit_news_submit", data, function( res ) {
        if (res == 1) {
          $('#failed').hide();
          $('#success').show();
        }else{
