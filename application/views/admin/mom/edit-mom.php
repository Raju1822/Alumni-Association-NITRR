    ...
    <div class="page-content container-fluid">
      <div class="panel">
        ...
        <div class="panel-body container">
          ...
          <?php 
            if ($mom_article) {
              $main_content_id = $mom_article->main_content_id;
              $content_category_id = $mom_article->content_category_id;
              $content_posted_by_user_id = $mom_article->content_posted_by_user_id;
              $main_content_name = $mom_article->main_content_name;
              $content_text = $mom_article->content_text;
              $content_date = $mom_article->content_date;
            }else{
...
<script>
    ...
    function submitMom(){
      ...
      $.post("<?php echo base_url() ?>Admin/edit_mom_submit", data, function( res ) {
        if (res == 1) {
          $('#failed').hide();
          $('#success').show();
        }else{
