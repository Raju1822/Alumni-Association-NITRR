...
<div class="body-wrapper container">
	<section class="userprofile-wrapper col-md-8">
		...
		<div class="row details-overview card">
			...
			<div class="main-details col-xs-8">
				...
				<?php if($this->session->userdata('logged_in_admin')){ ?>
						<br>
						<a href="<?=base_url()?>admin/verifyuser/<?php echo @$personal_details[0]->user_id; ?>/approve" class="btn green-bkgd"><i class="fa fa-check"></i></a>
						<a href="<?=base_url()?>admin/verifyuser/<?php echo @$personal_details[0]->user_id; ?>/decline" class="btn red-bkgd"><i class="fa fa-close"></i></a>
				<?php } ?>
		...
		<div class="row education card user-detail">
			...
			<hr>
			<?php if ($this->session->userdata('logged_in_admin')) { ?>	
				<p>Branch: <?php echo $user_branch;?></p>
				<p>Passing Year: <?php echo @$personal_details[0]->ug_passing_year; ?></p>
